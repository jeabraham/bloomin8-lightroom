...
Stops the currently playing playlist (gallery slideshow or playlist mode).
...
```json
{
  ...
  "paths": {
    "/stop": {
      "post": {
        "summary": "Stop Playlist Playback",
        "description": "Stops the currently playing playlist (gallery slideshow or playlist mode).",
        "tags": [
          "System APIs"
        ],
        "responses": {
          "200": {
            "description": "Playlist playback stopped successfully.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
